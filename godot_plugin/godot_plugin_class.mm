...
void PluginClass::_bind_methods() {
    ClassDB::bind_method(D_METHOD("status"), &PluginClass::status);
    ClassDB::bind_method(D_METHOD("requestTracking"), &PluginClass::requestTracking);
...
void PluginClass::requestTracking() {
    if (@available(iOS 14, *)) {
